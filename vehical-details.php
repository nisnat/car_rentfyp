...
if (isset($_POST['submit'])) {
  ...
  if ($query1->rowCount() == 0) {
    ...
    echo "<script>alert('Car already booked for these days, please try another car.');</script>";
    echo "<script type='text/javascript'> document.location = 'car-listing.php'; </script>";
  }
}
        ...
        <aside class="col-md-3">
          ...
          <div class="sidebar_widget">
            ...
            <form method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
              <label>Pick-Up & Drop-Off (Return Car) Time:</label>
                <textarea rows="4" class="form-control" name="message" placeholder="eg: pickup: 2.30pm, drop off: 4.30pm" required></textarea>
              </div>
              ...
              <div class="form-group">
                <label>Upload Driving License (Front Only):</label>
